...
import com.soma.lof.common.databinding.ItemHighlightVideoBinding

class HighLightVideoAdapter : ListAdapter<String, HighLightVideoAdapter.HighLightVideoViewHolder>(HighLightVideoDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HighLightVideoViewHolder {
        val binding = DataBindingUtil.inflate<ItemHighlightVideoBinding>(LayoutInflater.from(parent.context), R.layout.item_highlight_video, parent, false)
